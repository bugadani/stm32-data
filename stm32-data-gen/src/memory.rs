pub use stm32_data_serde::chip::memory::{self, Access, Settings};
pub use stm32_data_serde::chip::Memory;
...
static MEMS: RegexMap<&[Mem]> = RegexMap::new(&[
    ...
    ("STM32H7(.[57].I|4[57].G)",     mem!(ITCM { 0x00000000 64 }, BANK_1 { 0x08000000 1024 }, BANK_2 { 0x08100000 1024 }, RAM_D2 { 0x10000000 288 }, RAM_D3 { 0x18000000 64 },  DTCM { 0x20000000 128 },   RAM_D1 { 0x24000000 512 })),
